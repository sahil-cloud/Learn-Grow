                        ...
                        ?>
                                ...
                                <div class="card p-4 lg:w-1/2 ">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <span class="text-xl text-green-800 m-2"><strong>Score: <?php if($rt->num_rows > 0) {echo $score; } else { echo "0"; } ?>% </strong></span><span style="color: black;">(Score above 75% to get certificate)</span>
                                         <h3 class="text-gray-700 mb-1 mt-2">(The maximum marks of all attempt will be considered)</h3>

                                    </div>
                                        <a class="btn btn-success <?php if($rt->num_rows > 0){ if($score < 75) echo "disabled";} else { echo "disabled"; } ?> text-gray-900 m-2"  href="#"><strong>Download Certificate</strong></a>
                                </div>
                        <?php
                            }
                        }
